...
pairs = [
    [
        r"my name is (.*)",
        ["Julia: Hello %1, How are you today ?", ]
    ],
    [
        r"You: what is your name ?",
        ["Julia: My name is Julia and I'm a chatbot ?", ]
    ],
    [
        r"Julia:  how are you ?",
        ["I'm doing good\nHow about You ?", ]
    ...
    [
        r"(.*) created ?",
        ["I was created by Jasween", "top secret ;)", ]
    ],
    [
        r"(.*) are you wearing?",
    ...
    [
        r"(.*) joke",
        ['A guy in a plane stood up & shouted: “HIJACK!”\nAll passengers got scared\nFrom the other end of the plane, a guy shouted back “HI JOHN”.', ' Maybe math teachers are pirates in disguise. They seem suspiciously interested in finding the X.',
    ...
    [
        r"quit",
        [" Julia : Bye take care. See you soon :) ",
...
def mean():
    ...
    print("\n Julia :  People with the name  * ", name,
          " * generally have the following personsality \n \n")
    for i in range(0, 1):
        print(meaning[i].text),
    print("\n Julia : Is my analysis corrected?")
    input("\n You : ")
    print("\n Julia : Ok! \n ")
    print(" Julia : Btw ", name, " feel free to ask me anything ")
    pairs = input("\n You : ")
...
if __name__ == "__main__":
    ...
    print(" Julia : Hey", name,
          " would you like to know more about your name?\n\t\t\t(y or n)")
    choice = input("\n You : ")
    if choice == 'y':
